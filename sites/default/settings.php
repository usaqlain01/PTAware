 ...
 * @endcode
 */
$settings['hash_salt'] = '0L_vqZnq0zZxmZSrBFm8Ytx_dYjb7XHxy-_swN5y2_27wylIDQdKlEL_dwAT-TfrMpt2tKy7SQ';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_PTAware_dd.inc')) {
 require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_PTAware_dd.inc';
}
// </DDSETTINGS>
$databases['default']['default'] = array (
    'database' => 'PTAware',
...
$config_directories['sync'] = 'sites/PTAware.dd/files/config_lngQ3jzNthHXrqcWTBNh22VO6W7WPkmjMogOS1YIo6dBxYqiWzwaJiPChrgGn8_sTdZhKML6NA/sync';
